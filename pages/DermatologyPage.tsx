...
const team = [
    ...
    { name: 'Ranka Rajaković Popović', title: 'dr.med., univ. dipl, prav.,', description: 'Specialist dermatovenerolog in direktor'},
...
const bookingInfo = [
    { title: 'Prvi obisk', content: ['Pokličite na telefonsko številko 01 519 77 14 ali se naročite preko spleta.', 'Izbira zdravnika in termin: Če želite, si lahko sami izberete zdravnika Dermadenta, sicer vam zdravnika dodeli asistentka glede na vrsto težav in proste termine.', 'Ob obisku s seboj prinesite:\n· osebni dokument (os. izkaznica, potni list ali vozniško dovoljenje);\n· nekaj gotovine ali plačilno kartico.', 'Cena prvega pregleda: 80,00 €'] },
    { title: 'Ponovni obisk', content: ['Če ste se za termin dogovorili ob predhodnem obisku, se vam ni treba posebej naročati.', 'Če za termin niste dogovorjeni pokličite na telefonsko številko 01 519 77 14 ali se naročite preko spleta.', 'Če želite že dogovorjeni termin spremeniti, pokličite na telefonsko številko 01 519 77 14.', 'Ob obisku s seboj prinesite naročilni kartonček, ostale dokumente, ki sta jih naročila zdravnik ali asistentka.'] },
